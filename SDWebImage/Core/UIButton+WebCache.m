...
- (void)sd_setImageWithURL:(nullable NSURL *)url Compress:(BOOL)compress forState:(UIControlState)state {
    [self sd_setImageWithURL:url Compress:compress forState:state placeholderImage:nil options:0 completed:nil];
}

- (void)sd_setImageWithURL:(nullable NSURL *)url Compress:(BOOL)compress
                  forState:(UIControlState)state
          placeholderImage:(nullable UIImage *)placeholder{
    [self sd_setImageWithURL:url Compress:compress forState:state placeholderImage:placeholder options:0 completed:nil];
}
